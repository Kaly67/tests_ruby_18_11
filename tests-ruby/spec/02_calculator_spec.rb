...
describe "#multiply" do
  ...
  end # one other test here, don't forget do end ;)
...
describe "#power" do
  ...
  expect(power(2, 3)).to eq(8) # 2^3 = 8
  end
end
...
describe "#factorial" do
  it "computes the factorial of 0" do
    expect(factorial(0)).to eq(1) # Par convention, 0! = 1
  end
  ...
  it "computes the factorial of 2" do
    expect(factorial(2)).to eq(2) # 2! = 2
  end

  it "computes the factorial of 5" do
    expect(factorial(5)).to eq(120) # 5! = 5 * 4 * 3 * 2 * 1 = 120
  end

  it "computes the factorial of 10" do
    expect(factorial(10)).to eq(3628800) # 10! = 10 * 9 * ... * 1
  end
end
